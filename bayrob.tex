...
\PaperTitle{Briefing Title} % Article title
...
\Abstract{Bayrob Group's arrest and prosecution provides as windown into a cybercrime group that had fantastic operational security for nearly a decade of operation.}
...
%	BACKGROUND
%-----------------------------------
\section*{Background} % The \section*{} command stops section numbering
...
%	Current Status
%-----------------------------------
\section*{Current Status} % The \section*{} command stops section numbering
...
%	Key Considerations
%-----------------------------------
\section*{Key Considerations} % The \section*{} command stops section numbering
\addcontentsline{toc}{section}{Key Considerations} 
